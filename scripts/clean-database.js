...
async function cleanDatabase() {
  try {
    ...
    // Limpiar colección de contenido
    console.log('\n🗑️ Limpiando contenido subido...');
    ...
    // Verificar que solo queden datos de relleno
    ...
    console.log('✨ Solo quedan los datos de relleno originales');
